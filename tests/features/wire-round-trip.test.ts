...
const EVENTS: EventSamples = {
  ...
  tool_call_streaming: { type: "tool_call_streaming", id: "call_2", tool: "Bash", argChars: 1_240, at: 1_758_650_399_200 },
  tool_call_started: {
  ...
  context_update: { type: "context_update", contextTokens: 12345, outputTokens: 678, reasoningTokens: 400, contextWarn: true },
  ...
  turn_finished: {
    ...
    turnId: "t_1",
    stopReason: "end_turn",
    usage: { ...USAGE, reasoningTokens: 30, reasoningEstimated: true },
    contextTokens: 1050,
    overdriveSnapshot: "abc123",
    contextWarn: false,
